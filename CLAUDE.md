...
- **A Vitest suite of 1,189 tests across 40 files** in `app/test/` — ⚠️ **that number
  is the RUNNER's, read out of CI run `36176282598`, and it corrected a count taken by
  grepping the files an hour earlier (1,119).** A count off a file is a claim about the
  file. ⚠️ This entry said *"nearly 700 assertions"* until 2026-09-25.
