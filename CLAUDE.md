...
owner's phone signs in to carries 38 of the 40 migrations, so **`Genérico` and the widened
purchase fence are not on his phone.** This is 2026-09-22's shape again — caught this time
...
- **Migrations are append-only once applied.** Fix forward with a new numbered
  ...
  **Measured 2026-09-25: `0040` is the highest on disk, so the next is `0041`**
