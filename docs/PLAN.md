...
| ⚠️⚠️ **Should the app have an *"undo that sale"* button?** (round-three área 6) ⚠️ **RE-ASKED IN PLAIN LANGUAGE 2026-09-21 — the owner's answer was *"I don't remember what the 15-minute undo stands for"*, which is the question's fault, not his** | **`5h` — Vender**, and the completeness number §5 grades the pilot on | **WHAT IT IS, WITHOUT THE JARGON:** the cashier rings up the wrong thing and taps *undo*. ⚠️ **Nothing is edited or deleted** — `void_transaction` (`0021`) writes a MIRROR-IMAGE document that cancels the first, both stand in the ledger, and the shelf goes back to what it was. A document can be undone **at most once**. ⚠️⚠️ **THE "15 MINUTES" IS A ROLE BOUNDARY AND NOT A DEADLINE, which is why the old wording confused:** a **cashier** may undo **their own** sale within 15 minutes; **the owner or a manager may undo anything, at any time, with no window at all.** **RECOMMENDED: yes.** ⚠️ `0021` is applied and has **no caller**, so this is a screen over a finished function rather than new risk. ⚠️⚠️ **The pilot argument is the strong one: a mis-rung sale with no undo gets corrected by NOT RECORDING THE NEXT ONE**, or by a cashier who quietly stops trusting the app — and completeness within 5% is the number that decides whether the pilot passed |

✅✅ **TWO OF THE FOUR WERE RULED ON 2026-09-21, THE SAME DAY THEY WERE ASKED, AND ONE
OF THEM CAME BACK WITH A REQUIREMENT THE QUESTION HAD NOT CONTAINED.**
...
⚠️⚠️ **TWO REMAIN OWED, AND ONE OF THEM STILL BLOCKS THE PILOT'S MOST IMPORTANT
