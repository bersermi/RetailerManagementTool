...
⚠️⚠️ **SIX ENTRIES OF 2026-09-22 ARE ARCHIVED, IN FOUR CUTS TAKEN THE SAME DAY, TO
...
one.** `## Position` had reached **1,445 lines** before the first cut, and
`plan-handover.sh` assertion 7 names the remedy in its own failure.
