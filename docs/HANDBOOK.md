...
| **5b.8-iii-b** | **The box you actually type your name into** | ⚠️ **This is where the next piece of work is**, and nothing is waiting on you for it. The row above shipped on 2026-09-19, so the plumbing it needs exists. A field in **Ajustes**, on your own name rather than on the list of people — you fix yours, not somebody else's — and the list redraws straight away so you can see it took |
