...
| **5b-ii-a** | **The Ajustes sheet: who is in the shop, the join code, and text size** | ⚠️ **This is where the next piece of work is**, and nothing is waiting on you for it. ✅ **You ruled on 2026-09-18**: a staff member does not see the list of people — the database will not tell the app who they are, so the list would be blank rows |
