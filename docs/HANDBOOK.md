...
| **5b.8-ii** | **Showing the name in the list of people** | ✅ **Done 2026-09-18** — the Ajustes list stops saying *Dueño* and *Encargado* where it can say a person's name instead, and nothing was waiting on you for it. ⚠️ **Your no-names ruling of 2026-09-14 is now properly retired** — you overturned it on 2026-09-18, and a name was not really on screen until this shipped. ⚠️⚠️ **ONE THING IS WORTH YOUR WORD AND IT IS IN THE PLAN**: the *other* half of that old ruling was about the screen where **you approve somebody who asked to join** — that screen shows an email and no name. It turns out the name genuinely is not there to show: somebody who has only ASKED to join is not in your shop yet, so there is no row of theirs carrying a name. **We can fetch it cheaply if you want it** — the question is whether you should see the name of somebody you have not let in yet, and the requirement behind that screen is about being *"enough not to approve the wrong Juan"*. ⚠️ **It is cheap now and fiddly once that screen is built.** ⚠️ **And nobody can fix a wrong name yet** — a Google account that came through as one word now shows that one word to everyone in the shop, and only you as owner could change it. That is the next row |
| **5b.8-iii** | **Letting somebody fix their own name** | ⚠️ **This is where the next piece of work is**, and nothing is waiting on you for it. ⚠️ **It became urgent the moment the row above shipped**: names are on screen now, so a wrong one is visible to everybody in the shop and its owner cannot change it. **After the first piece; it does not have to wait for the second.** A field in Ajustes where a person edits their own name. ⚠️ **It exists because of a real gap**: as the database stands today only a shop's OWNER may change a membership row, so an **Encargado** or **Empleado** who signed in with Google and came through as one word could never correct it. ⚠️ **The naive fix would also let them promote themselves to owner**, so it is done as one narrow operation that touches the name and nothing else |
| **5b-iii** | **Someone asks to join, and you approve them** | After the two rows above. ⚠️ **It also carries a small database fix ruled on 2026-09-18**: the invite function reports five different problems with the same error code, and one of them — *this person already asked to join* — needs its own, because it is the only one with a next step. **It goes here because this is the screen that next step lands on.** Nothing is broken today; a check catches it if the wording ever changes |
| 5d–5h | The rest of the screens | After 5b |
| **—** | ⚠️ **One thing is waiting on YOU** | ⚠️⚠️ **ONE QUESTION IS OPEN AS OF 2026-09-18, AND IT DOES NOT HOLD UP THE NEXT PIECE OF WORK: when somebody asks to join your shop, should the approval screen show you their NAME, or only their email?** It is written up in full in the plan. The short version: names now exist, but a person who has only asked to join is not in your shop yet, so nothing of theirs carries one — **we can fetch it, cheaply, and the question is whether you want it shown.** ✅✅ **Ruled 2026-09-18 — área 9 is CLOSED and nothing is owed there.** Your words: *"we have already set the measures and would stick to see the Números screen in our Pilot and enhancing anything needed later."* ⚠️ **The earlier reading of this was wrong and the plan says so**: *"not about how it looks"* was said during the styling round, about the styling round, and the plan had turned it into a reopened área 9 and an expected migration. **Nothing reopens.** ✅ The undo question was answered the same day: **no undo.** ✅ **The paperwork fix of 2026-09-18 is settled too** — you said to fold it into `5b.8`, and it now rides with that task's first piece. ⚠️ **The block in `docs/PLAN.md` stays even when it is empty**, because it is the only thing that guarantees the next question gets put back in front of you |
