...
- `0025` — `replay_failed_write` **and the REPLAY MARKER** (**4.5c**). ⚠️ Nothing
  distinguishes a replayed document today, so §2.6's void-window exemption cannot be
  enforced or falsified until it does — `docs/PLAN.md` has owed this since 4e-ii-a
